...
namespace PurewaterEs\ScoutElastic\Traits;

use Exception;
use Hyperf\Utils\Arr;
use PurewaterEs\ScoutElastic\Config;
use Hyperf\Utils\ApplicationContext;
use Hyperf\Database\Model\Collection;
use Hyperf\Database\Model\SoftDeletes;
use PurewaterEs\ScoutElastic\SearchRule;
use PurewaterEs\ScoutElastic\ElasticEngine;
use PurewaterEs\ScoutElastic\SearchableScope;
use PurewaterEs\ScoutElastic\IndexConfigurator;
use PurewaterEs\ScoutElastic\Builders\FilterBuilder;
use PurewaterEs\ScoutElastic\Builders\SearchBuilder;
...
trait Searchable
{
    ...
    public function searchableUsing()
    {
        ...
        $indexerClass = '\\PurewaterEs\ScoutElastic\\Indexers\\' . ucfirst($indexerType) . 'Indexer';
